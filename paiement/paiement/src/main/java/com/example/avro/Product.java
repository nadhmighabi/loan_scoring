...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7926019018430246017L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.example.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"long\"}]}");
   ...
   */
  public Product(java.lang.Long id, java.lang.CharSequence name, java.lang.Long amount) {
    this.id = id;
    this.name = name;
    this.amount = amount;
  }
   ...
   */
  public static com.example.avro.Product.Builder newBuilder() {
    return new com.example.avro.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.example.avro.Product.Builder newBuilder(com.example.avro.Product.Builder other) {
    if (other == null) {
      return new com.example.avro.Product.Builder();
    } else {
      return new com.example.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.example.avro.Product.Builder newBuilder(com.example.avro.Product other) {
    if (other == null) {
      return new com.example.avro.Product.Builder();
    } else {
      return new com.example.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avro.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Product.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Product.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Product.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Product.Builder setAmount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Product.Builder clearAmount() {
